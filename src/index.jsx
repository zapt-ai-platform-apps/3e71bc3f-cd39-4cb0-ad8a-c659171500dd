...
window.progressierAppRuntimeSettings = {
  ...
  name: "Vehicle Repair Estimate Calculator",
  shortName: "Repair Estimator"
};
let pwScript = document.createElement('script');
pwScript.setAttribute('src', 'https://progressier.app/z8yY3IKmfpDIw3mSncPh/script.js');
pwScript.setAttribute('defer', 'true');
document.querySelector('head').appendChild(pwScript);
